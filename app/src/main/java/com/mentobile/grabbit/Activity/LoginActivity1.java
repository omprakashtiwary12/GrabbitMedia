 ...
 */
public class LoginActivity1 extends AppCompatActivity implements View.OnClickListener, GetWebServiceData, GoogleApiClient.OnConnectionFailedListener {
        ...
        switch (view.getId()) {
            case R.id.login_btn_login:
                ...
                if (username.length() < 1) {
                    ...
                    GetDataUsingWService getDataUsingWService = new GetDataUsingWService(LoginActivity1.this, AppUrl.LOGIN_URL, 100, content, true, "Logging ...", this);
    ...
    public void onBackPressed() {
        // super.onBackPressed();
        final AlertDialog.Builder builder = new AlertDialog.Builder(LoginActivity1.this);
    ...
    public void uploadresultforGoogle(String name, String email) {
//        StringBuilder stringBuilder = new StringBuilder();
//        stringBuilder.append("name=").append(name);
//        stringBuilder.append("&email=").append(email);
//        stringBuilder.append("&mobile=").append("");
//        stringBuilder.append("&password=").append("");
//        stringBuilder.append("&login_type=").append("Google");
//        stringBuilder.append("$gcm_id=").append(gcmid);
//        //stringBuilder.append("&otp").append(code + "");
//        String content = stringBuilder.toString();
//        GetDataUsingWService getDataUsingWService = new GetDataUsingWService(LoginActivity.this, Urls.URL_REGISTER, 0, content, true, "Loding ..", new GetWebServiceData() {
//            @Override
...
//                    int id = obj.getInt("result");
//                    String data = obj.getString("data");
//                    String user_id = obj.getString("id");
//                    AppPref.getInstance().setUserID(user_id);
//                    sendToActivity(MainActivity.class, Intent.FLAG_ACTIVITY_CLEAR_TOP);
//                    finish();
//                } catch (Exception e) {
//
//                }
            ...
            GraphRequest request = GraphRequest.newMeRequest(
                    ...
                    new GraphRequest.GraphJSONObjectCallback() {
                        ...
                        public void onCompleted(
                            ...
                            try {
                                Other.saveDataInSharedPreferences("11", object.getString("email").toString(), object.getString("name").toString(), "11");
                                Toast.makeText(LoginActivity1.this, "welcome ", Toast.LENGTH_LONG).show();
