...
public class NotificationActivity extends BaseActivity implements RecyclerAdapter.ReturnView, RecyclerAdapter.onItemClickListener {
    ...
    public void initialize() {
        GrabbitApplication.database.changeReadStatus();
        ...
        int i = 0;
        Cursor cursor = GrabbitApplication.database.getAllNotification(Database.TBL_NOTIFICATION);
        if (cursor.moveToFirst()) {
            do {
                ...
                String notify_dt = cursor.getString(7);
